 ...
 * @Author : EZEN 아카데미 Node.js 강의 (서지영, jen.jyseo@gmail.com)
 */

const fs = require("fs"); // FileSystem 모듈
const path = require("path"); // 경로문자열 제어 모듈

module.exports.mkdirs = (target, permissions = 0755) => {
  // 경로가 없다면 수행하지 않는다.
  ...
  // node.js 17버전 이상 가능.
  // -> target = 'a/b/c'
  // \\는 -> \만 하면 \뒤의 텍스트를 의미한다 -> 그래서 /뒤에 /를 붙혀 -> \를 가리키도록 하였다
